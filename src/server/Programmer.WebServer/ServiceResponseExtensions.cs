...
namespace Programmer.WebServer
{
    ...
    {
        private static readonly IDictionary<ServiceResponseResult, Func<object, string, IActionResult>> ServiceResponseToActionResultDictionary =
        new Dictionary<ServiceResponseResult, Func<object, string, IActionResult>>
        {
            ...
            { ServiceResponseResult.Accepted, (data, message) => BuildObjectResult(data, message,HttpStatusCode.Accepted)},
        ...
        {
            return ServiceResponseToActionResultDictionary[serviceResponse.Result](serviceResponse.Data, serviceResponse.Message);
        }
    }
}